...
// 聊天客服端程序实现，main线程用作发送线程，子线程序用作接收线程
            ...
            else
            {
                ...
                else
                {
                    ...
                    else // 登录成功
                    {
                        ...
                        static int readthreaddnumber = 0;
                        if (readthreaddnumber == 0)
                        {
...
void mainMenu(int clientfd)
{
...

    {
        ...
        // 调用相应命令的事件处理回调，mainmenu对修改封闭，添加新功能不需要改变函数
